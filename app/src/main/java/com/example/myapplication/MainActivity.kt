    ...
    Column(
        ...
        Button(
            modifier = Modifier
                ...
                .testTag(stringResource(id = R.string.continue_button)),
        ...
        Column(
            ...
            if (expanded) {
                Text(
                    ...
                    modifier = Modifier.testTag(stringResource(id = R.string.greeting_description))
                )
            }
        }
...
annotation class MultipleScreens